...
class App:
    def __init__(self):
        ...
        win32gui.SetWindowLong(self.hwnd, Constants.GWL_EXSTYLE, Constants.WS_EX_NOACTIVATE)
    ...
    def main(self):
        ...
        items_to_print = [
            ...
            " ",
            f"Mod-Manager Version: {self.version}",
            f"Looking for PROC: {self.settings_data['AnimeGamePROC']}",
            " ",
        ]
    ...
    def __main__(self):
        ...
        self.__set_window_size__(prev_game_window_size[0] * (self.settings_data["SizeRelative"][0]/100), prev_game_window_size[1] * (self.settings_data["SizeRelative"][1]/100))
        self.__set_window_position__(prev_game_window_position[0] + (prev_game_window_size[0]*(self.settings_data["PostionRelative"][0])), prev_game_window_position[1] + (prev_game_window_size[1]*(self.settings_data["PostionRelative"][1])))
        while True:
